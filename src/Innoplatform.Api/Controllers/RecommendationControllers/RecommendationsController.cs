...
public class RecommendationsController : BaseController
{
    ...
    [HttpPost]
    public async Task<IActionResult> AddAsync([FromForm] RecommendationForCreationDto dto)
    {
        var response = new Response
        {
            StatusCode = 200,
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult> UpdateAsync([FromRoute(Name = "id")] long id, [FromForm] RecommendationForUpdateDto dto)
    {
        var response = new Response
        {
            StatusCode = 200,
